...
// Fetch counts as before
$channel_count = 0;
$users_count = 0;
$designation_count = 0;
$employee_code_count = 0;

// Get channel count and data
$sql_channels = "SELECT COUNT(*) AS count FROM channel";
$result_channels = $conn->query($sql_channels);
if ($result_channels && $result_channels->num_rows > 0) {
    $row_channels = $result_channels->fetch_assoc();
    $channel_count = $row_channels['count'];
}
$channel_data = fetchTableData($conn, 'channel');
...
$users_data = fetchTableData($conn, 'users');

// Get designation count and data
$sql_designation = "SELECT COUNT(*) AS count FROM designation";
$result_designation = $conn->query($sql_designation);
if ($result_designation && $result_designation->num_rows > 0) {
    $row_designation = $result_designation->fetch_assoc();
    $designation_count = $row_designation['count'];
}
$designation_data = fetchTableData($conn, 'designation');

// Get employee code count and data
$sql_employee_codes = "SELECT COUNT(DISTINCT employee_code) AS count FROM users WHERE employee_code IS NOT NULL AND employee_code != ''";
$result_employee_codes = $conn->query($sql_employee_codes);
if ($result_employee_codes && $result_employee_codes->num_rows > 0) {
    $row_employee_codes = $result_employee_codes->fetch_assoc();
    $employee_code_count = $row_employee_codes['count'];
}
$employee_code_data = fetchTableData($conn, 'users'); // Using users table for employee codes
        ...
        <div class="card dash-widget">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    <h3><?php echo $channel_count; ?></h3>
                    <a href="http://localhost/hr/channels.php"><span>Channels</span></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card dash-widget">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    ...
                    <a href="http://localhost/hr/users.php"><span>Users</span></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card dash-widget">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    ...
                    <a href="http://localhost/hr/designation.php"><span>Designations</span></a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
        <div class="card dash-widget">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    <h3><?php echo $employee_code_count; ?></h3>
                    <a href="http://localhost/hr/users.php"><span>Employee Codes</span></a>
                </div>
            </div>
        </div>
    </div>
